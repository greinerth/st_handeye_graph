...
import numpy
__all__ = ['OptimizationParams', 'spatial_calibration_graph', 'spatial_calibration_visp']
class OptimizationParams:
    ...
    def __init__(self) -> None:
        ...
        """
def spatial_calibration_graph(camera_matrix: numpy.ndarray[numpy.float64[3, 3], numpy.ndarray.flags.f_contiguous], pattern_3d: numpy.ndarray[numpy.float64[m, n], numpy.ndarray.flags.f_contiguous], pattern_2ds: list[numpy.ndarray[numpy.float64[m, n]]], world2hands: list[numpy.ndarray[numpy.float64[6, 1]]], hand2eye: numpy.ndarray[numpy.float64[6, 1]], object2world: numpy.ndarray[numpy.float64[6, 1]], params: OptimizationParams = ...) -> tuple:
    ...
def spatial_calibration_visp(camera_matrix: numpy.ndarray[numpy.float64[3, 3], numpy.ndarray.flags.f_contiguous], pattern_3d: numpy.ndarray[numpy.float64[m, n], numpy.ndarray.flags.f_contiguous], pattern_2ds: list[numpy.ndarray[numpy.float64[m, n]]], world2hands: list[numpy.ndarray[numpy.float64[6, 1]]], hand2eye: numpy.ndarray[numpy.float64[6, 1]], object2world: numpy.ndarray[numpy.float64[6, 1]], params: OptimizationParams = ...) -> tuple:
    """
